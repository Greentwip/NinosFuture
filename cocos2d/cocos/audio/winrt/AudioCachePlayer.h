...
namespace experimental {
    ...
    class CC_DLL AudioPlayer : public IXAudio2EngineCallback, IXAudio2VoiceCallback
    {
    public:
        AudioPlayer();
        virtual ~AudioPlayer();
    ...
    public:
        class AudioEngineCacheThreadPool;
        static std::shared_ptr<AudioEngineCacheThreadPool> s_threadPool;
