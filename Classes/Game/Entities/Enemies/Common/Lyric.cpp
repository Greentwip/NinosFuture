...
void Lyric::setup() {
    ...
    Logical::composite<windy::Enemy>(this, LyricResources::armaturePath, LyricResources::spritePath, "lyric");
...
std::shared_ptr<cocos2d::Rect> Lyric::getEntryCollisionRectangle(const cocos2d::Point& position, const cocos2d::Size& size) {
    return Logical::buildEntryCollisionRectangle(position, size, LyricResources::armaturePath, "lyric");
}
